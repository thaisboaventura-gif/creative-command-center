    ...
    <Shell>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16, flexWrap: "wrap", gap: 8 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
          ...
          <a href="/d2c-evento"
            style={{ background: "#9333ea", color: "white", borderRadius: 6, padding: "6px 14px", fontSize: 12, fontWeight: 600, textDecoration: "none", display: "inline-block" }}>
            🎪 D2C Evento
          </a>
          <a href="/lancamentos"
            style={{ background: "#ea580c", color: "white", borderRadius: 6, padding: "6px 14px", fontSize: 12, fontWeight: 600, textDecoration: "none", display: "inline-block" }}>
            🚀 Lançamentos
          </a>
          <a href="/nova-demanda"
